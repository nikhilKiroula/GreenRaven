    ...
    <footer className="font-sans">
      ...
      <div className="bg-[#0a1128] py-12 px-4 relative overflow-hidden">
        ...
        <div className="container mx-auto flex flex-col md:flex-row items-center justify-between gap-6 max-w-7xl">
          ...
          <NavLink to={"/contact"}>
            {" "}
            <button className="bg-transparent border border-white/30 text-white hover:bg-green-600 hover:text-white cursor-pointer transition-colors px-8 py-3 uppercase text-sm tracking-widest font-medium">
              Contact Us
            </button>
          </NavLink>
        </div>
          ...
          <div className="flex flex-col lg:flex-row gap-12 lg:gap-8">
            ...
            <div className="lg:w-1/3 flex flex-col gap-8">
              ...
              <div className="flex gap-4 text-slate-400">
                <a
                  href="https://www.facebook.com/profile.php?id=61586330292574"
                ...
                {/* <a href="#" className="hover:text-green-400 transition-colors" target="_blank" rel="noopener noreferrer">
                  <Twitter size={16} />
                </a> */}
                <a
                  href="https://www.linkedin.com/company/green-raven-inc"
                  className="hover:text-green-400 transition-colors"
                  target="_blank"
                  rel="noopener noreferrer"
                  title="linkedin"
            ...
            <div className="lg:w-2/3">
              ...
              <div className="mt-12 pt-8 border-t border-slate-800/50">
                <h4 className="text-xs font-bold tracking-widest text-slate-500 uppercase mb-6">
                  Trusted Partners
                </h4>
        ...
        <div className="container mx-auto px-4 max-w-7xl">
          <div className="flex flex-col md:flex-row justify-between items-center gap-4">
            <div className="flex flex-wrap justify-center md:justify-start gap-4 text-xs text-slate-400 font-light">
              <p className="italic text-[12px] text-gray-300 hover:text-white">
                Website designed and developed by{" "}
                <a
                  href="https://mail.google.com/mail/?view=cm&to=makemyweb.team@gmail.com&subject=Website%20Development%20Inquiry&body=Hello%20MakeMyWeb%20Team,%0AI%20am%20interested%20in%20getting%20a%20website%20developed.%20Please%20share%20more%20details."
                  target="_blank"
                  rel="noopener noreferrer"
                  className="text-green-600 font-medium hover:underline"
                  title="Contact at: makemyweb.team@gmail.com"
                >
                  MakeMyWeb.Team
                </a>
              </p>
