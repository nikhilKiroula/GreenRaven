const processSteps = [
  { step: 1, title: "Submit Request",  description: "Provide your business details and financing needs" },
  { step: 2, title: "Get Quote",       description: "Receive a customized quote within 24 hours" },
  { step: 3, title: "Approval",        description: "Quick approval process with minimal documentation" },
  { step: 4, title: "Receive Funds",   description: "Get funded and start growing your business" },
];
    ...
    <section id="how-it-works" className="py-20 bg-slate-50">
      <div className="container mx-auto px-4">
        <div className="text-center mb-16">
          ...
          <p className="text-xl text-slate-600 max-w-2xl mx-auto">Simple, transparent process from quote to funding</p>
        </div>
        ...
        <div className="max-w-3xl">
          <h3 className="text-2xl font-bold text-slate-900 mb-6">Standard Process</h3>
