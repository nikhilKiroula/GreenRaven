      ...
      <div className="max-w-[1400px] mx-auto grid lg:grid-cols-2 gap-16 items-start">
        ...
        <div>
          ...
          <h2 className="text-4xl md:text-5xl font-bold leading-[1.15] mb-10 tracking-tight">
            ...
            <span className="text-green-600">Dominate Markets</span> When They
            Build Trust.
          </h2>
          {/* Large Image */}
        ...
        <div className="space-y-8">
          ...
          {/* Feature List */}
          <ul className="space-y-3 list-disc marker:text-green-600 text-gray-600 pt-2 pl-5">
            <li className="">
              We partner with national sales organizations for solar, generator,
              geothermal and more.
            </li>
